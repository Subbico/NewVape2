...
local _, subbed = pcall(function()
	return game:HttpGet('https://github.com/Subbico/NewVape2')
end)
...
local function downloadAsset(fileName)
    ...
    if not isfile(assetPath) then
        local suc, res = pcall(function()
            return game:HttpGet('https://raw.githubusercontent.com/Subbico/NewVape2/main/assets/new/' .. fileName, true)
        end)
